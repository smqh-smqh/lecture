...
class VGGNet(Model):
    def __init__(self):
        ...
        self.c1 = Conv2D(input_shape=(32, 32, 3), filters=64, kernel_size=(3,3), strides=1,padding='same')  # 卷积层
        self.b1 = BatchNormalization()  # BN层
        self.a1 = Activation('relu')  # 激活层
        self.c2 = Conv2D(input_shape=(32, 32, 3), filters=64, kernel_size=(3, 3),strides=1, padding='same')  # 卷积层
