...
class LSTM_Model(Model):
    def __init__(self):
        ...
        # self.r2 = LSTM(50, activation='relu', return_sequences=False, unroll=True)
        self.d1=Dropout(0.2)
        self.f1=Dense(1)
        # self.r2 = LSTM(10, activation='relu', return_sequences=False, unroll=True)
        # self.d2 = Dropout(0.2)
        # self.f2 = Dense(1)
...
checkpoint_save_path = "./checkpoint_4/stock.ckpt"
...
history = model.fit(x_train, y_train, epochs=50, batch_size=16, shuffle=True, validation_data=(x_test, y_test), validation_freq=1,
